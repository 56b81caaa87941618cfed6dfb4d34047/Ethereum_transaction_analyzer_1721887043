...
*/
Vue.component("simple_footer_component_1721887045", {
    template: `
                ...
                <div id="footer-content" class="text-center">
                    <div class="flex">
                        <a id="footer-logo-link" href="#" class="flex-1 flex items-center justify-center mb-5 text-2xl font-semibold text-gray-900 dark:text-white">
                            ...
                            EtherTrace - Ethereum Transaction Analytics
                        </a>
                    </div>
                </div>
                <div class="flex">
                    <div id="footer-text" class="flex-1 block text-sm text-center text-gray-500 dark:text-gray-400">
                        Gain real-time insights into new Ethereum transactions. Powerful filtering and alerting tools for tracking tokens, smart contracts, and activity from specific addresses.
                    </div>
                </div>
            </div>
        </footer> 
